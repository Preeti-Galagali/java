...
public class HashMapUseCase {
	 ...
	 public static void main(String[] args) {
	        ...
	        studentMap.put(101, "Preeti");
	        studentMap.put(102, "Harsha");
	        studentMap.put(103, "Urvi");
	        studentMap.put(104, "Milan");
	        studentMap.put(105, "Rohit");
	        ...
	        // Updating a value
	        studentMap.put(102, "Harsha C");  // Updating name for ID 102
